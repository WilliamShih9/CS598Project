# -*- coding: utf-8 -*-
"""ReplicateFigure3.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1FXEoy6bYXS0QCkdhRwiHLihoA4NwhPuv
"""
...
CAML_model.load_state_dict(torch.load("CAML_model"))
CAML_model

CNN_model = CNN(batchsize, len(word_to_ix), len(label_to_ix))
CNN_model.load_state_dict(torch.load("CNN_model"))
CNN_model
...
LSTMattn_model.load_state_dict(torch.load("LSTMattn_model"))
LSTMattn_model

KSI_CAML_model = CAML(batchsize, len(word_to_ix), len(label_to_ix))
KSI_CAML_model.load_state_dict(torch.load("KSI_CAML_model"))
KSI_CNN_model = CNN(batchsize, len(word_to_ix), len(label_to_ix))
KSI_CNN_model.load_state_dict(torch.load("KSI_CNN_model"))
KSI_LSTM_model = LSTM(batchsize, len(word_to_ix), len(label_to_ix))
KSI_LSTM_model.load_state_dict(torch.load("KSI_LSTM_model"))
KSI_LSTMattn_model = LSTMattn(batchsize, len(word_to_ix), len(label_to_ix))
KSI_LSTMattn_model.load_state_dict(torch.load("KSI_LSTMattn_model"))
